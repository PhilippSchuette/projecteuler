...
| ------- | --------- | -------------- |------------ | ----------- | ---------- | -------------- | -------------- |
|       1 |         6 |    + (0.00s)   |  + (0.00s)  |     TBD     |  + (0.23s) |    + (0.00s)   |    + (0.00s)   |
|       2 |         6 |    + (0.00s)   |  + (0.00s)  |     TBD     |  + (0.17s) |    + (0.04s)   |    + (0.00s)   |
|       3 |         3 | _**+ (33.0s)**_|    -        |       -     |     -      |    + (0.89s)   |    + (0.84s)   |
|       4 |         3 |    + (0.09s)   |    -        |     TBD     |     -      |    + (0.07s)   |    + (0.16s)   |
|       5 |         4 |    + (0.00s)   |    -        |     TBD     |     -      | _**+ (6.74s)**_|    + (0.16s)   |
|       6 |         3 |    + (0.00s)   |    -        |     TBD     |     -      |    + (0.00s)   |    + (0.00s)   |
|       7 |         4 |    + (0.29s)   |    -        |  + (0.028s) |     -      | _**+ (5.14s)**_|    + (0.021s)  |
|       8 |         3 |    + (0.00s)   |    -        |       -     |     -      |    + (0.00s)   |    + (0.00s)   |
|       9 |         3 |    + (0.60s)   |    -        |     TBD     |     -      |    + (0.00s)   |    + (0.01s)   |
