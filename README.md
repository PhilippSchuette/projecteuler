...
| Problem | Solutions | Fastest Python |   Fastest C | Fastest C++ | Fastest JS |     Fastest Go |   Fastest Rust |
| ------- | --------- | -------------- |------------ | ----------- | ---------- | -------------- | -------------- |
|       1 |         6 |    + (0.00s)   |  + (0.00s)  |  + (0.00s)  |  + (0.23s) |    + (0.00s)   |    + (0.00s)   |
|       2 |         6 |    + (0.00s)   |  + (0.00s)  |  + (0.00s)  |  + (0.17s) |    + (0.04s)   |    + (0.00s)   |
|       3 |         3 | _**+ (33.0s)**_|  + (0.01s)  |       -     |     -      |    + (0.83s)   |    + (0.84s)   |
|       4 |         3 |    + (0.09s)   |    -        |  + (0.01s)  |     -      |    + (0.07s)   |    + (0.16s)   |
|       5 |         4 |    + (0.00s)   |    -        |  + (0.07s)  |     -      | _**+ (6.74s)**_|    + (0.16s)   |
|       6 |         3 |    + (0.00s)   |    -        |  + (0.00s)  |     -      |    + (0.00s)   |    + (0.00s)   |
|       7 |         4 |    + (0.29s)   |    -        |  + (0.028s) |     -      | _**+ (5.14s)**_|    + (0.021s)  |
|       8 |         3 |    + (0.00s)   |    -        |       -     |     -      |    + (0.00s)   |    + (0.00s)   |
|       9 |         4 |    + (0.60s)   |    -        |  + (0.01s)  |     -      |    + (0.00s)   |    + (0.01s)   |
|      10 |         4 | _**+ (19.9s)**_|    -        |  + (0.66s)  |     -      | _**+ (2.04s)**_|    + (0.98s)   |
|      11 |         2 |    + (0.00)    |    -        |       -     |     -      |        -       |    + (0.00s)   |
|      12 |         4 |       -        |    -        |  + (>8min)  |     -      |        -       | _**+ (1.45s)**_|
|      13 |         2 |    + (0.00s)   |    -        |       -     |     -      |        -       |    + (0.00s)   |
|      14 |         3 |       -        |    -        |  + (0.25s)  |     -      |        -       |    + (0.27s)   |
