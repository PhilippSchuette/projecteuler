...
#
# (see ../input_files/problem013.txt)
#
# --
#
# Solution description: Since Python ints use arbitrary precision we can
#   just sum up all the numbers without worrying about integer overflow. 
#   When arbitrary precision is no available, one would probably have to
#   use long division.
#
# Author: Tom Praschan
# Date: 2019/02/11
